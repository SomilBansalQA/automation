...
public class VerifyNon1941ShopsForWomen extends CoachTest {
	...
	@Test(groups = { "desktop", "mobile" })
	public void TestStep02_SelectAnyNon1941ShopsForWomen() {
		dsl.selectAnyNon1941ShopsForWomen();
		Reporter.log("User selects any Non-1914 shop for women");
	...
	public void TestStep06_VerifyImageOnPLP() {
		dsl.verifyImage();
		Reporter.log("Image is verified On PLP");
