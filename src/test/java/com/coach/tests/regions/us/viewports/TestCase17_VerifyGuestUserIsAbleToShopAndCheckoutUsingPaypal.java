...
public class TestCase17_VerifyGuestUserIsAbleToShopAndCheckoutUsingPaypal extends CoachTest {
	...
	// @Test(groups={"desktop","mobile"})
	// public void
	// TestStep11_VerifyErrorMessageIsdisplayedWhenEnteringInvalidCredentialsForPaypal(){
	// dsl.selectPaymentMethodAsPaypala(payPal.get("Email"));
	// dsl.makePaymentUsingPayPal(payPal.get("Email"), payPal.get("123"));
	// dsl.verifyErrorMessageIsdisplayedWhenEnteringInvalidCredentialsForPaypal();
	//
	// }
