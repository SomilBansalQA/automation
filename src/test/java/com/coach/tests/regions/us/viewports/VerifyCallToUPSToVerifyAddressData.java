...
public class VerifyCallToUPSToVerifyAddressData extends CoachTest{
	...
	public void TestStep07_ShipingTheProduct(){
		dsl.enterShipingDetails(shipping.get("FirstName"),shipping.get("LastName"),"11 W 34TH STD",shipping.get("Country"),"10002",shipping.get("City"),shipping.get("PhoneNumber"));
		dsl.verifyAddressVerificationUPSServer();
	}
