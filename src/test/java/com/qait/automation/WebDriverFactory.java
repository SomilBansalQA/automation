...
//		System.out.println("browser is :"+seleniumconfig.get("browser"));
            ...
            try{
                ...
                if(seleniumconfig.get("seleniumserver").equalsIgnoreCase("remote")){
                    seleniumconfig.put("seleniumserverhost"
                            , (String)regConfig.get("seleniumserverhost"));
                }
...
//			cap.setCapability("device", "iPhone 6S Plus");
				...
				cap.setCapability("platform", "MAC");
				cap.setCapability("device", "iPad Air 2");
//				cap.setCapability("browserName", "iPhone");
//				cap.setCapability("platform", "MAC");
//				cap.setCapability("device", "iPhone 6S Plus");
...
//	}
	...
	private static WebDriver getChromeDriver() {
            /** 
             * Ramandeep: making ChomeDriver path dynamic
             *  Pick it from ENV is "CHROME_PATH" exists
             *   ELSE pick assume its set in System PATH
             **/
		String CHROME_PATH = "C:\\Users\\somilbansal\\Desktop\\Driver\\chromedriver.exe";
     		System.out.println("path of chromeDriver -> "+CHROME_PATH);
     		System.setProperty("webdriver.chrome.driver", CHROME_PATH);
                if(System.getenv().containsKey("CHROME_PATH")){
                 //  String CHROME_PATH = System.getenv("CHROME_PATH");
                  //  String CHROME_PATH = "C:\\Users\\somilbansal\\Desktop\\Driver\\chromedriver.exe";
        		System.out.println("path of chromeDriver -> "+CHROME_PATH);
        		System.setProperty("webdriver.chrome.driver", CHROME_PATH);
                }
