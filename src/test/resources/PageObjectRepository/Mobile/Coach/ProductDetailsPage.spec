...
tag_product_full_description				  css							.pdp-info__details>h2
...
product_name                                css                              .product-name.long-name
tag_product_detail						    css							.pdp-info__details>h2
btn_sizeChart								css							.custom-select.select-size
tableSizeChart                              css                         .table.size-chart-table.table-striped.numeric th:nth-child(${text})
