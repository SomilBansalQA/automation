...
button_Email_WishList                   xpath           //span[@class='icon-coach-mail']
...
Text_Email_FillMessage                  xpath           //textarea[@id='dwfrm_sendtofriend_message']
...
Label_your_wishlist                     xpath            //a[contains(text(),'GO TO WISHLIST')]
...
label_sendToFriendYouAreSigningMsg      xpath            //label[@for='dwfrm_sendtofriend_addtoemaillist']
span_removeWishlist                     xpath            //span[@class='icon-coach-close-grey']
button_confirm                          xpath            //button[@class='btn danger']
italy_label_sendtoyourfriend            xpath            //label[@for='dwfrm_sendtofriend_addtoemailsignuplist']
italy_label_addtorecommendationlist     xpath            //label[@for='dwfrm_sendtofriend_addtorecommendationlist']
popup_whislist                          css               .goToWishlist
